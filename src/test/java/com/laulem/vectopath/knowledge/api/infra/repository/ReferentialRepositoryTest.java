...
import com.laulem.vectopath.knowledge.api.infra.dto.GroupResponse;
...
import com.laulem.vectopath.knowledge.api.infra.dto.PermissionResponse;
...
class ReferentialRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        VectoPathReferentialApiProperties properties = new VectoPathReferentialApiProperties();
